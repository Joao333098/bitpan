        ...
        async def _init_browser(self):
                ...
                if self.playwright_browser is None:
                        if self.config.cdp_url:
                                ...
                                import os as _os
                                _chromium_path = _os.environ.get('PLAYWRIGHT_CHROMIUM_EXECUTABLE_PATH')
                                _launch_kwargs = dict(
                                        headless=True,
                                        args=[
                                                '--no-sandbox',
                                ...
                                self.playwright_browser = await self.playwright.chromium.launch(**_launch_kwargs)
                ...
                if self.current_page is None:
                        ...
                        self._attach_console_listener(self.current_page)

                return self
        
        def _attach_console_listener(self, page: Page):
                """Attach a console message listener to a page."""
